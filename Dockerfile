FROM ubuntu:trusty
RUN apt-get update && apt-get install -y wget tar gzip bin86 tcsh lib32stdc++6 libc6-i386 libc6-dev-i386 lib32stdc++6 libc6-i386 libc6-dev-i386 lib32z1 lib32ncurses5 lib32bz2-1.0 qemu-kvm make build-essential bc && sudo apt-get clean && rm -rf /var/lib/apt/lists/*
